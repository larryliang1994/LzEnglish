...
public class CardPopup extends RelativePopupWindow {
    ...
    public CardPopup(Context context) {
        View view = LayoutInflater.from(context).inflate(R.layout.popup_card, null);
        setContentView(view);
    ...
    public void setListener(View.OnClickListener listener) {
        getContentView().findViewById(R.id.textView_delete).setOnClickListener(listener);
        getContentView().findViewById(R.id.textView_getText).setOnClickListener(listener);
    }
